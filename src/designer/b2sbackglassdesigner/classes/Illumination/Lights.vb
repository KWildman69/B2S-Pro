                    ...
                    With bulb
                        If Not newimages.ContainsKey(.ID) OrElse .IsIlluminatedImageDirty Then
                            ...
                            getin = (getin AndAlso ((Not onlyrenderalwaysonlights AndAlso Not onlyrenderonlights) OrElse
                                                    (onlyrenderalwaysonlights AndAlso .InitialState = 2 AndAlso Not (.BlinkEnabled AndAlso .IlluMode <> eIlluMode.Flasher AndAlso Not .IsImageSnippit) AndAlso Not (.IsImageSnippit AndAlso .SnippitInfo.PivotAnimationEnabled)) OrElse
                                                    (onlyrenderonlights AndAlso .InitialState >= 1 AndAlso Not (.IsImageSnippit AndAlso .SnippitInfo.PivotAnimationEnabled))))
                            If getin Then
